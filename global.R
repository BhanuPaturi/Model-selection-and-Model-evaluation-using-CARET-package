...
glmnet_initial <- c("center", "scale","impute_knn","dow", "dummy", "nzv", "naomit") # <-- These are arbitrary starting values. Set these to your best recommendation
pls_initial <- c("dow","center","scale","impute_knn","dummy","zv", "naomit")   # <-- These are arbitrary starting values. Set these to your best recommendation
...
gbm_initial <- c("dow", "impute_knn","center", "scale", "dummy", "nzv") 
lm_initial <- c("dow", "impute_knn","center", "scale", "dummy", "nzv") 
glmStepAIC_initial <- c("center", "scale", "impute_knn","dow","dummy","nzv", "naomit") 
kNN_initial <- c("impute_knn","center", "scale","dow", "dummy", "nzv")
gamSpline_initial <- c("dow", "center", "scale",  "impute_bag", "dummy", "zv", "naomit")
cubist_initial <- c("impute_bag","center","scale","dow")
M5_initial <- c("dow", "impute_knn")
svmLinear_initial <- c("dow", "impute_knn","center", "scale", "dummy", "zv", "naomit")
svmPoly_initial <- c("dow", "impute_bag","center", "scale", "dummy", "zv", "naomit")
brnn_initial <- c("dow", "impute_bag","center", "scale", "dummy", "zv", "naomit")
NNet_initial <- c("dow", "impute_knn","center", "scale", "dummy", "zv", "naomit")
